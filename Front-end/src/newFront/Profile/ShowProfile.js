    ...
    return (
        <React.Fragment>
            <div className='profilecard'>
                <div className="modal fade" id="exampleModalUpload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">UPLOAD MEMBER PHOTO</h5>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" onClick={UploadMemberImage}>Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="text-center">
                    {profiledetail.avatar ? <img src={NEW_URL + profiledetail.avatar} className="rounded-circle" alt="Profile " /> : <img src={"https://media.istockphoto.com/vectors/user-icon-flat-isolated-on-white-background-user-symbol-vector-vector-id1300845620?b=1&k=20&m=1300845620&s=612x612&w=0&h=AGv0X8A5n8D_2iETctrUbpJqonP-Mvb3RrWkWJqKZfE="} className="rounded-circle" alt="Deault" />}
                    <br />
