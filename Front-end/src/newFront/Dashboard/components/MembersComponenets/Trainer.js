...
const Trainer = () => {
  ...
  const UploadTrainerImage = () => {
    ...
    axios.post(API_URL + "addTrainerImage", body).then((response) => {
      alert("Image Added");
      axios.get(API_URL + "getAllTrainers").then((response) => {
        console.log(response.data.data);
        setAllTrainerList(response.data.data);
