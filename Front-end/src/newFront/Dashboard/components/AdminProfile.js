...
const AdminProfile = () => {
  ...
  useEffect(() => {
    ...
    //var id = localStorage.getItem("id");
    axios.get(`${API_URL}getAllInfo/${id}`).then((response) => {
  ...
  const UploadMemberImage = () => {
    ...
    axios.post(API_URL + "addUserImage", body).then((response) => {
      alert("Image Added");
      setIMG(thumbnail);
      axios.get(`${API_URL}getAllInfo/${id}`).then((response) => {
        console.log(response.data.data);
      ...
      <div className="profilecard">
        ...
        <div className="text-center">
          {profiledetail.avatar ? (
            <img
              src={NEW_URL + profiledetail.avatar}
          ...
          <div className="card profilecard2">
            ...
            <div className="card-footer text-muted">
              {updateinfobox ? (
                ...
                <button className="btn btn-success" onClick={updateInfo}>
                  UpdateInfo
                </button>
              )}
            </div>
